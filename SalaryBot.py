...
def main(job_title):
    ...
    with open(f"C:\\Users\\Leo Zhang\\Documents\\GitHub\\SalaryBot\\data_salaries\\salary-results-{job_title}-{time.strftime('%Y-%m-%d-%H-%M-%S')}.csv", 'w', newline='', encoding='utf-8') as f:
        writer = csv.writer(f)
...
if __name__ == '__main__':
    ...
    positions = ['data-scientist-i', 'devops-engineer-i']
